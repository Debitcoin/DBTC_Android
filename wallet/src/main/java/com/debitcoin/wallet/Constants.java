package com.debitcoin.wallet;

import android.text.format.DateUtils;

import com.debitcoin.core.coins.NewCoinMain;
...
import com.debitcoin.core.network.CoinAddress;
import com.debitcoin.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String VERSION_URL = "http://debitcoin.com/version";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
	        new CoinAddress(NewCoinMain.get(),      new ServerAddress("electrum2.cryptolife.net", 22103),
                                                    new ServerAddress("electrum2.cryptolife.net", 23103),
													new ServerAddress("electrum2.cryptolife.net", 24103)),
    ...
    static {
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.NEWCOIN_MAIN.getCoinType(), "http://127.0.0.1:3001/tx/%s");
    }
