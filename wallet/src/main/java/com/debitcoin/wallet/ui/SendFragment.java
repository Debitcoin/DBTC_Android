...
import com.debitcoin.core.coins.FiatType;
...
import com.debitcoin.core.messages.MessageFactory;
import com.debitcoin.core.messages.TxMessage;
import com.debitcoin.core.uri.CoinURI;
import com.debitcoin.core.uri.CoinURIParseException;
import com.debitcoin.core.util.ExchangeRate;
import com.debitcoin.core.util.GenericUtils;
import com.debitcoin.core.wallet.WalletAccount;
import com.debitcoin.core.wallet.exceptions.NoSuchPocketException;
import com.debitcoin.wallet.AddressBookProvider;
import com.debitcoin.wallet.Configuration;
import com.debitcoin.wallet.Constants;
...
import com.debitcoin.wallet.tasks.MarketInfoPollTask;
import com.debitcoin.wallet.ui.widget.AddressView;
import com.debitcoin.wallet.ui.widget.AmountEditView;
import com.debitcoin.wallet.util.ThrottlingWalletChangeListener;
import com.debitcoin.wallet.util.UiUtils;
...
import static com.debitcoin.core.coins.Value.canCompare;
import static com.debitcoin.wallet.ExchangeRatesProvider.getRates;
import static com.debitcoin.wallet.util.UiUtils.setGone;
import static com.debitcoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.debitcoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
