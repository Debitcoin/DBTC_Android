package com.debitcoin.core.uri;
...
import com.debitcoin.core.coins.BitcoinTest;
import com.debitcoin.core.coins.CoinType;
import com.debitcoin.core.coins.DashMain;
...
import com.debitcoin.core.coins.NuSharesMain;
...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://debitcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://debitcoin.com?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://debitcoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://debitcoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        assertEquals("https://debitcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://debitcoin.com?address=" + goodAddressStr,
